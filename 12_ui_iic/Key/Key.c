...
void key_read(void)
{
    ...
    {
        switch (ui_flag) {
            case 1: para1 += 5; break;
            case 2: para2 += 10; break;
        }
    }
    ...
    if(para1>25) para1 =0; if(para1<0) para1=25;
    if(para2>40) para2 =0; if(para2<0) para2=40;
}
...
void oled_show(void)
{
    ...
    for(i=1;i<=2;i++)
    {
        ...
        switch (ui_temp) {
            case 1: OLED_ShowString(0, i, "para1:", 8);OLED_ShowNum(45, i, para1, 2, 8); break;
            case 0: OLED_ShowString(0, i, "para2:", 8);OLED_ShowNum(45, i, para2, 2, 8); break;
        
        }
    }
    OLED_ShowString(95, 1, "**", 8);
    ui_flag_pre = ui_flag;
